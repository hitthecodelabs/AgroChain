...
function AssignRoles() {
    ...
    return (
        ...
        <Card className="step-card">
            <Card.Header as="h5">Productores:</Card.Header>
            <Card.Body>
        ...
        <Card className="step-card">
            <Card.Header as="h5">Procesadores:</Card.Header>
            <Card.Body>
        ...
        <Card className="step-card">
            <Card.Header as="h5">Distribuidores:</Card.Header>
            <Card.Body>
        ...
        <Card className="step-card">
            <Card.Header as="h5">Mayoristas:</Card.Header>
            <Card.Body>
